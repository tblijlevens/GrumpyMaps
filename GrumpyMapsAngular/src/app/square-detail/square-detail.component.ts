...
export class SquareDetailComponent implements OnInit {
    ...
    setPlayerZoneSize(player:Player){
        ...
        for (var i = 0 ; i < player.zones.length ; i++){
            ...
            var zoneHeightWidth = +(radius / this.mapSettings.squareSize).toFixed(1);
    ...
    setAllTileZones(){
        for (var i = 0 ; i < this.mapSettings.allSquares.length ; i++){
            this.setTileZoneSize(this.mapSettings.allSquares[i]);
        }
    }
    ...
    getPlayerSquare(player:Player){
        ...
        for (var i = 0 ; i < this.mapSettings.allSquares.length ; i++){
            if (this.mapSettings.allSquares[i].mapSquareId == player.mapSquareId){
